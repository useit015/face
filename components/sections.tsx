...
const skillChipClass =
	"inline-flex items-center gap-1.5 text-body text-foreground-secondary transition-colors hover:text-foreground";
								...
								{strip.map((entry, i) => (
									...
									>
										...
										<div className="flex min-w-0 items-center gap-2">
											<span className="squircle flex size-8 shrink-0 items-center justify-center rounded-md border border-border bg-card">
												<SkillIcon
													name={entry.icon}
													className="size-4 text-foreground-secondary"
												/>
											...
											{entry.url ? (
												<a
													...
													target="_blank"
													rel="noreferrer"
													className="truncate text-body font-medium underline-offset-3 decoration-foreground-decoration transition-[text-decoration-color,color] duration-200 hover:text-foreground hover:underline"
												>
													{entry.company}
												</a>
											) : (
